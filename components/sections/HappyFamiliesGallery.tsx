    ...
    >
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <div className="inline-flex max-w-full items-center justify-center gap-2 rounded-full border border-[#3A241A]/10 bg-[#FFF9EF]/70 px-4 py-2 text-center text-[11px] font-bold uppercase tracking-[0.18em] text-[#8D5B26] shadow-lg shadow-[#3A241A]/5 sm:text-xs">
              <Sparkles
                aria-hidden="true"
              ...
              <span className="text-center">Happy Families</span>
            </div>
          </motion.div>
        ...
        {loading ? (
          ...
          >
            {Array.from({ length: 6 }).map((_, index) => (
              <motion.article
                ...
                className="w-full max-w-[360px] overflow-hidden rounded-[1.75rem] border border-[#3A241A]/[0.07] bg-[#FFFEFB] p-2 shadow-[0_18px_48px_rgba(58,36,26,0.065)]"
              >
          ...
          <motion.div
            ...
            className="mx-auto mt-16 w-full max-w-2xl rounded-[1.75rem] border border-[#3A241A]/[0.07] bg-[#FFFEFB] p-8 text-center shadow-[0_18px_48px_rgba(58,36,26,0.065)] sm:p-10"
          >
            <Images
              aria-hidden="true"
        ...
        <motion.div
          ...
          className="mx-auto mt-16 flex w-full max-w-[1120px] items-center justify-center pb-4 text-center lg:mt-20 [&_a]:h-14 [&_a]:rounded-full [&_a]:px-8 [&_a]:text-base [&_a]:font-bold"
        >
          <Button href="/gallery">
