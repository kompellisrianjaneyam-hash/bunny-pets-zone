...
export default function HeroSection() {
  return (
    <section
      id="home"
      className={`relative isolate overflow-hidden bg-[#FFF9EF] pb-24 pt-[230px] ${FONT_BODY} scroll-mt-[230px] sm:pb-28 sm:pt-[170px] sm:scroll-mt-[170px] lg:pb-32 lg:pt-[190px] lg:scroll-mt-[190px]`}
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="mt-3 block bg-gradient-to-r from-[#8A5522] via-[#C99045] to-[#B77932] bg-clip-text text-transparent">
          ...
          >
            <Link
              ...
              className="
                ...
                leading-none
                text-white
                shadow-[0_18px_42px_rgba(138,85,34,0.26)]
                outline-none
                transition
                duration-300
                hover:-translate-y-0.5
                hover:shadow-[0_22px_52px_rgba(138,85,34,0.34)]
            ...
            <a
              ...
              className="
                ...
                leading-none
                text-[#2A1B14]
                shadow-[0_12px_34px_rgba(58,36,26,0.07)]
                outline-none
                backdrop-blur-xl
                transition
                duration-300
              ...
              return (
                <motion.div
                  ...
                  className="
                    ...
                    leading-5
                    text-[#2A1B14]
                    shadow-[0_12px_30px_rgba(58,36,26,0.06)]
                    backdrop-blur-xl
                  "
                >
                  <Icon
        ...
        >
          ...
          <motion.div
            ...
            className="
              ...
              py-10
              text-center
              shadow-[0_24px_70px_rgba(58,36,26,0.12)]
              backdrop-blur-2xl
              sm:px-10
              sm:py-12
            "
          >
            ...
            <div
              className="
                ...
                bg-white/75
                p-3
                shadow-[inset_0_1px_0_rgba(255,255,255,0.9),0_16px_38px_rgba(58,36,26,0.10)]
              "
            >
            ...
            <p className="relative mt-3 text-sm font-bold uppercase tracking-[0.14em] text-[#9A6429]">
              Trusted Pet Store
            </p>

            <p className="relative mt-3 text-base font-semibold leading-6 text-[#5E4A3D]">
              {settings.address}
            </p>
          </motion.div>
              ...
              return (
                <motion.div
                  ...
                  className="
                    ...
                    leading-5
                    text-[#2A1B14]
                    shadow-[0_14px_34px_rgba(58,36,26,0.07)]
                    backdrop-blur-xl
                    transition
                    duration-300
                    hover:bg-[#FFF4E4]
